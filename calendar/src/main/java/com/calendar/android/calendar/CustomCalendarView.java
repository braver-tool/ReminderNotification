...
public class CustomCalendarView extends LinearLayout {
    ...
    private void getAttributes(AttributeSet attrs) {
        ...
        calendarBackgroundColor = R.drawable.calendar_bg;
        ...
        //int dayOfMonthTextColor = typedArray.getColor(R.styleable.CustomCalendarView_dayOfMonthTextColor, getResources().getColor(R.color.black));
        ...
        selectedDayBackground = R.drawable.selected_date_bg;
        ...
        currentDayOfMonth = R.drawable.selected_date_bg;
        //currentDayOfMonthBgTest = R.drawable.rounded_corner_date_testing;
        days = typedArray.getColor(R.styleable.CustomCalendarView_days, getResources().getColor(R.color.white));
        typedArray.recycle();
    }
    ...
    private void initializeCalendar() {
        ...
        previousMonthButton.setOnClickListener(v -> {
            ...
            refreshCalendarOne(currentCalendar);
            if (calendarListener != null) {
    ...
    private void initializeTitleLayout() {
        ...
        String dateTitleText = dateText + " " + currentCalendar.get(Calendar.YEAR);
        dateTitle.setText(dateTitleText);
        dateTitle.setTextColor(calendarTitleTextColor);
    ...
    private void setDaysInCalendar(Calendar cal) {
        ...
        for (int i = 1; i < 43; i++) {
            ...
            if (CalendarUtils.isSameMonth(calendar, startCalendar)) {
                ...
                dayView.setBackgroundResource(calendarBackgroundColor);
    ...
    private void setDaysInCalendarOne(Calendar cal) {
        Calendar calendar = Calendar.getInstance(locale);
        calendar.setTime(cal.getTime());
        calendar.set(Calendar.DAY_OF_MONTH, 1);
        calendar.setFirstDayOfWeek(getFirstDayOfWeek());
        ...
        boolean isSameMonth = CalendarUtils.isSameMonth(calendar1, cal);
        if (isSameMonth) {
            markDayAsCurrentDay(cal);
        }
    ...
    private View getView(Calendar currentCalendar) {
        View childView;
        int index1 = getDayIndexByDate(currentCalendar);
        childView = view.findViewWithTag(CustomCalendarView.DAY_OF_MONTH_TEXT + index1);
        return childView;
    }
    ...
    public void refreshCalendar(Calendar currentCalendar) {
        ...
        setDaysInCalendar(currentCalendar);
    }

    public void refreshCalendarOne(Calendar currentCalendar) {
        this.currentCalendar = currentCalendar;
        this.currentCalendar.setFirstDayOfWeek(getFirstDayOfWeek());
        locale = Locale.getDefault();
        initializeTitleLayout();
        initializeWeekLayout();
        setDaysInCalendarOne(currentCalendar);
    }
    ...
    public void markDayAsCurrentDay(Calendar calendar) {
        if (calendar != null) {
            ...
            dayOfMonth.setBackgroundResource(currentDayOfMonth);
        }
    ...
    public void markDayAsSelectedDay(Date currentDate) {
        ...
        if (!CalendarUtils.isPastDay(currentDate)) {
